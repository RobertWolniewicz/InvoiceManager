...
namespace EmailSender
{
    public class Email
    {
        ...
        public async Task Send(string subject, string body, string to, HttpPostedFileBase fileUploader)
        {
            ...
            if (fileUploader != null && fileUploader.ContentLength > 0)
            {
                ...
                AddAttachment(fileUploader, fileName);
            }
        ...
        public void AddAttachment(HttpPostedFileBase fileUploader, string fileName)
        {
            _mail.Attachments.Add(new Attachment(fileUploader.InputStream, fileName));
        }
    }
}
